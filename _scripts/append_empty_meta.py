...
TEMPLATE_ARTICLE = SCRIPT_DIR / "article_meta.tmpl.yml"
TEMPLATE_CHAPTER = SCRIPT_DIR / "chapter_meta.tmpl.yml"
...
def main():
    ...
    for file_path in md_files:
        ...
        template = template_chapter if is_chapter_readme(
            rel_path) else template_article
